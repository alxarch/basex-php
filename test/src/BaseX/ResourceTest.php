...
class ResourceTest extends TestCaseDb
{
  ...
  public function setUp()
  {
    ...
    $this->raw = new GenericResource($this->db, 'image.jpg');
    $this->raw->setModified(B::date('2012-05-27T12:36:48.000Z'));
    $this->xml = new GenericResource($this->db, 'collection/doc.xml');
    $this->xml->setModified(B::date('2012-05-27T13:38:33.988Z'));
