...
//  
  ...
  public function testUnlink()
  {
    ...
    $this->assertTrue(unlink("basex://$this->dbname/test.xml"));
    
    $this->assertEmpty($this->ls());
    
    $this->assertFalse(unlink("basex://123$this->dbname/test.xml"));
  }
  public function testParser()
  {
    $out = fopen("basex://$this->dbname/test.html#html", 'w');
    $this->assertTrue(is_resource($out));
    $in = "<body><a id='3'/><h1>dada</h1><p>dasfasdf</body>";
    fwrite($out, $in);
    fclose($out);
  ...
  {
    $out = fopen("basex://$this->dbname/test.html?skipcorrupt=0&addraw=0#html", 'w');
    $this->assertTrue(is_resource($out));
    $in = "<body><a id='3'/><h1>dada</h1><p>dasfasdf</body>";
    fwrite($out, $in);
    fclose($out);
